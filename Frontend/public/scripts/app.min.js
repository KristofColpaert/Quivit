...
renderToString:deprecated('renderToString','ReactDOMServer','react-dom/server',ReactDOMServer,ReactDOMServer.renderToString),renderToStaticMarkup:deprecated('renderToStaticMarkup','ReactDOMServer','react-dom/server',ReactDOMServer,ReactDOMServer.renderToStaticMarkup)});React.__SECRET_DOM_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ReactDOM;module.exports = React;},{"106":106,"23":23,"35":35,"45":45,"63":63}],2:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
 ...
 */'use strict';module.exports = '0.14.2';},{}],85:[function(_dereq_,module,exports){ /**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
 * This source code is licensed under the BSD-style license found in the
...
var Game = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            "div",
            { key: this.props.teams, className: "card game" },
            React.createElement(
                "span",
            ...
            React.createElement(
                "h3",
                { className: "teams", style: this.getStyles() },
                this.props.teams
            )
        );
    }
    ...
    render: function render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(GamesPanel, { title: 'Live Games', games: [React.createElement(Game, { teams: 'KAA Gent - RSCA', score: '0-2', timePassed: "43'", colors: ["#09509E", "#523091"] }), React.createElement(Game, { teams: 'FC Barcelona - Man. City', score: '1-3', timePassed: "60'", colors: ["#940F08", "#5CBFEB"] }), React.createElement(Game, { teams: 'Stoke City - KV Mechelen', score: '1-0', timePassed: "23'", colors: ["#09509E", "#523091"] }), React.createElement(Game, { teams: 'Sevilla - Villareal', score: '1-1', colors: ["#09509E", "#523091"] })] }),
                React.createElement("div", { className: "clearfix" }),
                React.createElement(GamesPanel, { title: 'Finished Games', games: [React.createElement(Game, { teams: 'België - Spanje', colors: ["#09509E", "#523091"], score: '3-2' }), React.createElement(Game, { teams: 'Zweden - Portugal', score: '0-0', colors: ["#FFD90D", "#FF1600"] }), React.createElement(Game, { teams: 'Chelsea - Swansea', score: '0-4', colors: ["#09509E", "#523091"] })] }),
                React.createElement("div", { className: "clearfix" })
            )
        );
    }
...
var GamesPanel = (function (_React$Component2) {
    _inherits(GamesPanel, _React$Component2);

    function GamesPanel() {
        _classCallCheck(this, GamesPanel);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(GamesPanel).apply(this, arguments));
    }

    _createClass(GamesPanel, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'section',
    ...
    _createClass(Game, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'time passed' })
            );
        }
    }]);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'section',
                    { className: 'content-holder' },
                    _react2.default.createElement(GamesPanel, { title: 'Live Games', games: [_react2.default.createElement(Game, { teams: 'KAA Gent - RSCA', score: '0-2' }), _react2.default.createElement(Game, { teams: 'FC Barcelona - Man. City', score: '1-3' }), _react2.default.createElement(Game, { teams: 'Stoke City - KV Mechelen', score: '1-0' }), _react2.default.createElement(Game, { teams: 'Sevilla - Villareal', score: '1-1' })] }),
                    _react2.default.createElement('div', { className: 'clearfix' }),
                    _react2.default.createElement(GamesPanel, { title: 'Finished Games', games: [_react2.default.createElement(Game, { teams: 'België - Spanje', score: '3-2' }), _react2.default.createElement(Game, { teams: 'Zweden - Portugal', score: '0-0' }), _react2.default.createElement(Game, { teams: 'Chelsea - Swansea', score: '0-4' })] }),
                    _react2.default.createElement('div', { className: 'clearfix' })
                )
            );
        }
