    ...
    dataParser.parse(beaconData[0], function(error, beaconObject) {
        accuracyFilter.filterAccuracy(beaconObject, function(resultArray) {
            ...
            if(resultArray.length == 4) {
                ...
                var positionObjects = [
                    { x : 0, y : 0, distance : ((resultArray[0].accuracy * 100) * 1.4) },
                    { x : 280, y : 0, distance : ((resultArray[1].accuracy * 100) * 1.4) },
                    { x : 395, y : 240, distance : ((resultArray[2].accuracy * 100) * 1.4) },
                    { x : 370, y : 85, distance : ((resultArray[3].accuracy * 100)) }
                ];
