...
var DESCRIPTORS        = require('./$.descriptors.js')
  ...
  , $                  = require('./$')
  , fails              = require('./$.fails.js')
  , $def               = require('./$.def.js')
  , $buffer            = require('./$.buffer.js')
  , ctx                = require('./$.ctx.js')
  , strictNew          = require('./$.strict-new.js')
  , propertyDesc       = require('./$.property-desc.js')
  , $hide              = require('./$.hide.js')
  , isInteger          = require('./$.is-integer.js')
  , toInteger          = require('./$.to-integer.js')
  , toLength           = require('./$.to-length.js')
  , toIndex            = require('./$.to-index.js')
  , toPrimitive        = require('./$.to-primitive.js')
  , isObject           = require('./$.is-object.js')
  , toObject           = require('./$.to-object.js')
  , isArrayIter        = require('./$.is-array-iter.js')
  , isIterable         = require('./core.is-iterable.js')
  , getIterFn          = require('./core.get-iterator-method.js')
  , wks                = require('./$.wks.js')
  , arrayMethods       = require('./$.array-methods.js')
  , arrayIncludes      = require('./$.array-includes.js')
  , $fill              = require('./$.array-fill.js')
  , $copyWithin        = require('./$.array-copy-within.js')
  , speciesConstructor = require('./$.species-constructor.js')
  , $iterators         = require('./es6.array.iterator.js')
  , Iterators          = require('./$.iterators.js')
  , $iterDetect        = require('./$.iter-detect.js')
  , setSpecies         = require('./$.set-species.js')
